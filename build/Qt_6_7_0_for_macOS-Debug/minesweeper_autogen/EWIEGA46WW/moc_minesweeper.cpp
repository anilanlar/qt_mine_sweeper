...
struct qt_meta_stringdata_CLASSMinesweeperENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSMinesweeperENDCLASS = QtMocHelpers::stringData(
    "Minesweeper"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSMinesweeperENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Minesweeper::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSMinesweeperENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSMinesweeperENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSMinesweeperENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *Minesweeper::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSMinesweeperENDCLASS.stringdata0))
